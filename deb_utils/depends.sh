...
depends="python-pip, python-virtualenv, python-setuptools, solr-jetty, python-lxml, python-imaging, python-psycopg2, libapache2-mod-wsgi, git-core, mercurial, subversion"
